# Capability: Plugin Decomposition

## Purpose

Defines how skill content and plugin directories are separated so plugins are thin manifests and canonical skill content lives outside plugin boundaries.
