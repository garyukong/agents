...
Create or update unit tests for this PR using an **80/20** approach: cover the key behaviours and regression risks
introduced by the diff, without over-indexing on exhaustive edge cases.
