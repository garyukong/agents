---
name: llm-langchain-agent
description: Build LangChain/LangGraph agents with modern patterns. Use when constructing LangGraph agents, multi-agent systems, or AI workflows with tools, memory, and observability.
---
...
Build sophisticated AI agent system for: Describe your agent requirements below.
