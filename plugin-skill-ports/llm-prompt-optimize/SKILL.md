...
description: Prompt optimizer using CoT, few-shot, and constitutional AI patterns. Use when improving prompt quality, reducing hallucinations, or optimizing LLM costs.
---
...
Describe your prompt optimization requirements below.
